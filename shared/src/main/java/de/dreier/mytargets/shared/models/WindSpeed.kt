...
data class WindSpeed(
    ...
    companion object {
        fun getList(context: Context): List<WindSpeed> {
            ...
            list.add(
                WindSpeed(
                    0, context.getString(R.string.bft_0),
                    R.drawable.ic_bft_0_black_24dp
                )
            )
            list.add(
                WindSpeed(
                    1, context.getString(R.string.bft_1),
                    R.drawable.ic_bft_1_black_24dp
                )
            )
            list.add(
                WindSpeed(
                    2, context.getString(R.string.bft_2),
                    R.drawable.ic_bft_2_black_24dp
                )
            )
            list.add(
                WindSpeed(
                    3, context.getString(R.string.bft_3),
                    R.drawable.ic_bft_3_black_24dp
                )
            )
            list.add(
                WindSpeed(
                    4, context.getString(R.string.bft_4),
                    R.drawable.ic_bft_4_black_24dp
                )
            )
            list.add(
                WindSpeed(
                    5, context.getString(R.string.bft_5),
                    R.drawable.ic_bft_5_black_24dp
                )
            )
            list.add(
                WindSpeed(
                    6, context.getString(R.string.bft_6),
                    R.drawable.ic_bft_6_black_24dp
                )
            )
            list.add(
                WindSpeed(
                    7, context.getString(R.string.bft_7),
                    R.drawable.ic_bft_7_black_24dp
                )
            )
            list.add(
                WindSpeed(
                    8, context.getString(R.string.bft_8),
                    R.drawable.ic_bft_8_black_24dp
                )
            )
            list.add(
                WindSpeed(
                    9, context.getString(R.string.bft_9),

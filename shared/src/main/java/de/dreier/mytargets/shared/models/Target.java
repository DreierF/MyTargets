...
public class Target extends IdProvider {
    ...
    static {
        list = new ArrayList<>();
        list.add(new Target("WA", R.drawable.wa));
        list.add(new Target("WA Spot 5-10", R.drawable.wa_spot_5));
        list.add(new Target("WA Spot 6-10", R.drawable.wa_spot_6));
        list.add(new Target("WA 3er Spot", R.drawable.wa_spot_6));
        list.add(new Target("WA Field",  R.drawable.wa_field));

...
data class WindDirection internal constructor(
    ...
    companion object {
        fun getList(context: Context): List<WindDirection> {
            ...
            list.add(
                WindDirection(
                    0, context.getString(R.string.front),
                    R.drawable.ic_arrow_downward_black_24dp
                )
            )
            list.add(
                WindDirection(
                    1, context.getString(R.string.back),
                    R.drawable.ic_arrow_upward_black_24dp
                )
            )
            list.add(
                WindDirection(
                    2, context.getString(R.string.left),
                    R.drawable.ic_arrow_right_black_24px
                )
            )
            list.add(
                WindDirection(
                    3, context.getString(R.string.right),
                    R.drawable.ic_arrow_left_black_24dp
                )
            )
            list.add(
                WindDirection(
                    4, context.getString(R.string.left_front),
                    R.drawable.ic_arrow_bottom_right_black_24dp
                )
            )
            list.add(
                WindDirection(
                    5, context.getString(R.string.right_front),
                    R.drawable.ic_arrow_bottom_left_black_24dp
                )
            )
            list.add(
                WindDirection(
                    6, context.getString(R.string.left_back),
                    R.drawable.ic_arrow_up_right_black_24dp
                )
            )
            list.add(
                WindDirection(
                    7, context.getString(R.string.right_back),

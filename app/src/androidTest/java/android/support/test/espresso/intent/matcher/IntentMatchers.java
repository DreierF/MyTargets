...
public final class IntentMatchers {
   ...
   * {@link ComponentNameMatchers#hasClassName}. The input string must contain the package name +
   ...
   * {@see ComponentName#getClassName}. For example:
   ...
   *
   * @param componentMatcher can be the value of {@link ComponentNameMatchers#hasClassName},
   * {@link ComponentNameMatchers#hasPackageName} or
   * {@link ComponentNameMatchers#hasShortClassName}
   */

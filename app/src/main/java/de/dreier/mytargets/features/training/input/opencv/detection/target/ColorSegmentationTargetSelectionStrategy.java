...
public class ColorSegmentationTargetSelectionStrategy extends ColorSegmentationTargetSelectionStrategyBase implements ITargetDetectionStrategy {
    ...
    public ITransformation detectTargetFace(Mat image, Target target) {
        ...
        Mat bin2 = segmentationForColor(hsv, new Scalar(170, 115, 190), new Scalar(180, 180, 255));
        // (241,45%,75%)-(256,71%,100%)
        Mat bin3 = segmentationForColor(hsv, new Scalar(27, 102, 190), new Scalar(29, 255, 255));
        // (39,40%,75%)-(40,100%,100%)

        //RotatedRect rotatedRect1 = findAndDrawCenteredContour(bin1);
        RotatedRect rotatedRect1 = findAndDrawCenteredContour(bin2);
        RotatedRect rotatedRect3 = findAndDrawCenteredContour(bin3);

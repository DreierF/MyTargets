...
public class FabLabel extends TextView {
    ...
    private int mColorNormal = 0xFF333333;
    private int mColorPressed = 0xFF444444;
    private int mColorRipple = 0x66FFFFFF;
    ...
    void onActionDown() {
        ...
        } else if (Utils.hasLollipop() && mBackgroundDrawable instanceof RippleDrawable) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (mFab == null || !mFab.isClickable() || !mFab.isEnabled()) {

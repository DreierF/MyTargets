...
public class RectD implements Parcelable {
	 ...
	 */
	public RectD(long left, long top, long right, long bottom) {
		this.left = left;
		this.top = top;
		this.right = right;
		this.bottom = bottom;
	 ...
	 */
	public void offsetTo(long newLeft, long newTop) {
		right += newLeft - left;
		bottom += newTop - top;
		left = newLeft;
		top = newTop;
	 ...
	 */
	public boolean contains(long left, long top, long right, long bottom) {
	 ...
	 */
	public boolean intersects(long left, long top, long right, long bottom) {

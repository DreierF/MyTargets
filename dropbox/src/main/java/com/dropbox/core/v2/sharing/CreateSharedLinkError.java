...
public final class CreateSharedLinkError {
    // union sharing.CreateSharedLinkError (shared_links.stone)
     ...
     *     preconditions.
     */
    private CreateSharedLinkError(Tag _tag, LookupError pathValue) {
        this._tag = _tag;
    ...
    static class Serializer extends UnionSerializer<CreateSharedLinkError> {
        ...
        @Override
        public void serialize(CreateSharedLinkError value, JsonGenerator g) throws IOException, JsonGenerationException {
            switch (value.tag()) {
                case PATH: {
                    g.writeStartObject();
                    writeTag("path", g);
        ...
        @Override
        public CreateSharedLinkError deserialize(JsonParser p) throws IOException, JsonParseException {
            CreateSharedLinkError value;
            boolean collapsed;
            String tag;
            ...
            if (tag == null) {
                ...
                value = CreateSharedLinkError.path(fieldValue);
            }
            else {

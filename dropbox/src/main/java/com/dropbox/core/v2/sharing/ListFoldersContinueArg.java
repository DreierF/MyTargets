...
class ListFoldersContinueArg {
    // struct sharing.ListFoldersContinueArg (sharing_folders.stone)
    ...
    static class Serializer extends StructSerializer<ListFoldersContinueArg> {
        ...
        @Override
        public void serialize(ListFoldersContinueArg value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ListFoldersContinueArg deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ListFoldersContinueArg value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new ListFoldersContinueArg(f_cursor);
            }
            else {

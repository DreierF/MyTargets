...
public class ListMembersAppsResult {
     ...
     *     cursor to {@link
     *     DbxTeamTeamRequests#linkedAppsListMembersLinkedApps(String)} to
     *     retrieve the rest.
     ...
     * DbxTeamTeamRequests#linkedAppsListMembersLinkedApps(String)} to retrieve
     * the rest.
     *
     ...
     * DbxTeamTeamRequests#linkedAppsListMembersLinkedApps(String)} to receive

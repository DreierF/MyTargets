...
public class SharedFileMetadata {
    ...
    public SharedFileMetadata(FolderPolicy policy, String previewUrl, String name, String id) {
        this(policy, previewUrl, name, id, null, null, null, null, null, null);
    }
    ...
    public static class Builder {
        ...
        public SharedFileMetadata build() {
            return new SharedFileMetadata(policy, previewUrl, name, id, permissions, ownerTeam, parentSharedFolderId, pathLower, pathDisplay, timeInvited);
        }
    }
    ...
    static class Serializer extends StructSerializer<SharedFileMetadata> {
        ...
        public SharedFileMetadata deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new SharedFileMetadata(f_policy, f_previewUrl, f_name, f_id, f_permissions, f_ownerTeam, f_parentSharedFolderId, f_pathLower, f_pathDisplay, f_timeInvited);
            }
            else {

...
class RelocationArg extends RelocationPath {
    ...
    /**
     * If true, {@link DbxUserFilesRequests#copy(String,String)} will copy
     * contents in shared folder, otherwise {@link
     * RelocationError#CANT_COPY_SHARED_FOLDER} will be returned if {@link
     * RelocationArg#getFromPath} contains shared folder. This field is always
     * true for {@link DbxUserFilesRequests#move(String,String)}.
     *
    ...
    public static class Builder {
         ...
         *     {@link RelocationArg#getFromPath} contains shared folder. This
         *     field is always true for {@link
         *     DbxUserFilesRequests#move(String,String)}. Defaults to {@code
        ...
        public RelocationArg build() {
            return new RelocationArg(fromPath, toPath, allowSharedFolder, autorename);
        }
    }
    ...
    static class Serializer extends StructSerializer<RelocationArg> {
        ...
        public RelocationArg deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ...
            if (tag == null) {
                ...
                value = new RelocationArg(f_fromPath, f_toPath, f_allowSharedFolder, f_autorename);
            }
            else {

...
class MembersListContinueArg {
    // struct team.MembersListContinueArg (team_members.stone)
    ...
    static class Serializer extends StructSerializer<MembersListContinueArg> {
        ...
        @Override
        public void serialize(MembersListContinueArg value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public MembersListContinueArg deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            MembersListContinueArg value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new MembersListContinueArg(f_cursor);
            }
            else {

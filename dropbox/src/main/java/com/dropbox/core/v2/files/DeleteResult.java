...
public class DeleteResult {
    ...
    static class Serializer extends StructSerializer<DeleteResult> {
        ...
        @Override
        public void serialize(DeleteResult value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public DeleteResult deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            DeleteResult value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
            ...
            if (tag == null) {
                ...
                value = new DeleteResult(f_metadata);
            }
            else {

...
class ListMembersDevicesArg {
    // struct team.ListMembersDevicesArg (team_devices.stone)
     ...
     *     members.
     */
    public ListMembersDevicesArg(String cursor, boolean includeWebSessions, boolean includeDesktopClients, boolean includeMobileClients) {
        this.cursor = cursor;
     ...
     * DbxTeamTeamRequests#devicesListMembersDevices} the cursor shouldn't be
    ...
    /**
     * Builder for {@link ListMembersDevicesArg}.
     */
    public static class Builder {
         ...
         *
         * @param cursor  At the first call to the {@link
         *     DbxTeamTeamRequests#devicesListMembersDevices} the cursor
        ...
        /**
         * Builds an instance of {@link ListMembersDevicesArg} configured with
         * this builder's values
         *
         * @return new instance of {@link ListMembersDevicesArg}
         */
        public ListMembersDevicesArg build() {
            return new ListMembersDevicesArg(cursor, includeWebSessions, includeDesktopClients, includeMobileClients);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        // be careful with inheritance
            ...
            ListMembersDevicesArg other = (ListMembersDevicesArg) obj;
    ...
    static class Serializer extends StructSerializer<ListMembersDevicesArg> {
        ...
        @Override
        public void serialize(ListMembersDevicesArg value, JsonGenerator g, boolean collapse) throws IOException, JsonGenerationException {
            if (!collapse) {
                g.writeStartObject();
            }
        ...
        @Override
        public ListMembersDevicesArg deserialize(JsonParser p, boolean collapsed) throws IOException, JsonParseException {
            ListMembersDevicesArg value;
            String tag = null;
            if (!collapsed) {
                expectStartObject(p);
                tag = readTag(p);
            ...
            if (tag == null) {
                ...
                value = new ListMembersDevicesArg(f_cursor, f_includeWebSessions, f_includeDesktopClients, f_includeMobileClients);
            }
            else {

...
public final class ListFileMembersError {
    // union sharing.ListFileMembersError (sharing_files.stone)
     ...
     *     preconditions.
     */
    private ListFileMembersError(Tag _tag, SharingUserError userErrorValue, SharingFileAccessError accessErrorValue) {
        this._tag = _tag;
